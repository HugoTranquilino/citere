			...
			<div class="col-md-6 text-secction-info">
				...
				<div class="container circulo">
					...
					<div class="circulo-valores">
						<h3>VALORES</h3>
						<img class="c1" id="c1" src="<?php echo base_url();?>assets/img/nosotros/c-1.png"
							alt="Valor de la Integridad">
						<img class="c2" id="c2" src="<?php echo base_url();?>assets/img/nosotros/c-2.png"
							alt="Valor de la Autocritica">
						<img class="c3" id="c3" src="<?php echo base_url();?>assets/img/nosotros/c-3.png"
							alt="Valor de la Disiplina">
						<img class="c4" id="c4" src="<?php echo base_url();?>assets/img/nosotros/c-4.png"
							alt="Valor de la Cercania">
					</div>
